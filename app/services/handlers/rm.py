...
class RmTaskHandler(BaseTaskHandler):
    ...
    async def validate(self, request: TaskRequest) -> None:
        ...
        self._resolve_rm_target_path(request)
    ...
    async def execute(self, request: TaskRequest) -> TaskResult:
        ...
        target_path, mount_path, mount_info = self._resolve_rm_target_path(request)
        ...
        worker_count = int(K8S_RM_DEFAULT_N_WORKERS)
